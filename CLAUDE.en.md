...
11. **Read-only requests** (report / list / what moved / is anything broken) **must not change the JSON.** State in one line that the JSON was not changed (e.g. "No changes" / "wbs.json was not modified").
