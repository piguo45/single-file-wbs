"""状態フィルタ(#91)：表示専用＝行を間引くだけ・データ/横軸は不変。
3排他状態(未着手/進行中/完了)のON/OFF・親残し判定・左右の高さ同期・横軸固定・サマリ不変・永続化・全OFF graceful。
本日=CLOCK_PIN(2026-06-15)固定。done=実績終了あり / wip=着手のみ / todo=実績なし。"""
...
DATA = {"projects": [{"name": "P", "milestones": [], "tasks": [
    {"id": "1", "name": "工程1", "children": [
        ...
        leaf("1.2", "進行中タスク", ps="2026-06-08", pe="2026-06-20", as_="2026-06-12"),
